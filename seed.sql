...
('Nicaraguan Coffee Beans', 'Single-origin Nicaraguan coffee beans.', 21.99, 1, 'Nicaraguan_Coffee.png', 'in stock', '250g'),
('Colombian Coffee Beans', 'Single-origin Colombian coffee beans.', 22.50, 1, 'Colombian_Coffee.png', 'in stock', '250g'),
('Brazilian Coffee Beans', 'Single-origin Brazilian coffee beans.', 17.99, 1, 'Brazagian_coffee.png', 'in stock', '250g'),
('Ethiopian Coffee Beans', 'Single-origin Ethiopian coffee beans.', 18.50, 1, 'Ethiopian_coffee.png', 'in stock', '250g'),
('Arabic Coffee Beans', 'Single-origin Arabic coffee beans.', 12.00, 1, 'Arabic_coffee.png', 'in stock', '250g'),
...
('Black Cold Brew', 'Ready-made black cold brew coffee.', 8.99, 3, 'Black_coldbrew.png', 'in stock', '330ml'),
('Nitro Cold Brew', 'Nitro-infused cold brew coffee.', 8.99, 3, 'nitro_coldbrew.png', 'in stock', '330ml'),
