...
('Chocolate Coffee Pods', 'Delicious chocolate flavoured coffee pods.', 7.99, 2, 'assets\images\chocolatepods.png', 'in stock', 'Pods'),
('Toffee Nut Coffee Pods', 'Sweet toffee nut flavoured coffee pods.', 7.99, 2, 'assets\images\toffee_pods.png', 'in stock', 'Pods'),
('Rich Hazelnut Coffee Pods', 'Rich hazelnut flavoured coffee pods.', 7.99, 2, 'assets\images\Hazelenut_pods.png', 'in stock', 'Pods'),
('Creamy Caramel Coffee Pods', 'Creamy caramel flavoured coffee pods.', 7.99, 2, 'assets\images\creamy_caramel_pods.png', 'in stock', 'Pods'),
('Vanilla Coffee Pods', 'Smooth vanilla flavoured coffee pods.', 7.99, 2, 'assets\images\Coffee_pods.png', 'in stock', 'Pods'),
('Black Cold Brew', 'Ready-made black cold brew coffee.', 8.99, 3, 'assets\images\Black_coldbrew.png', 'in stock', 'Cold Brew'),
('Nitro Cold Brew', 'Nitro-infused cold brew coffee.', 8.99, 3, 'assets\images\nitro_coldbrew.png', 'in stock', 'Cold Brew'),
('Berry Infused Cold Brew', 'Cold brew coffee infused with berry flavors.', 8.99, 3, 'assets\images\berry_coldbrew.png', 'in stock', 'Cold Brew'),
('Oat Milk Cold Brew', 'Cold brew coffee with oat milk.', 8.99, 3, 'assets\images\oatmilk_coldbrew.png', 'in stock', 'Cold Brew'),
('Mocha Cold Brew', 'Mocha flavored cold brew coffee.', 8.99, 3, 'assets\images\Mocha_coldbrew.png', 'in stock', 'Cold Brew'),
